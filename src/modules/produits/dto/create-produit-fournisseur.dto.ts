import { IsInt, IsOptional, IsString, IsBoolean, IsNumber, Min, MaxLength } from 'class-validator';
import { Type } from 'class-transformer';

export class AjouterFournisseurDto {
  @IsInt({ message: 'L\'ID du fournisseur doit être un entier' })
  @Type(() => Number)
